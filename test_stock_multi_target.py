"""
Test script for StockPredictor multi-target prediction functionality.
"""
import pandas as pd
import numpy as np
...
print("=" * 80)
print("StockPredictor Multi-Target Prediction Test")
print("=" * 80)
...
try:
    model1 = StockPredictor(
        ...
        asset_type='crypto',  # Use crypto to avoid weekend issues in test
        d_token=32,
        n_layers=2,
        n_heads=2,
        verbose=True
